 ...
 * It encapsulates details about an error, including timestamp, status, error type, message, and request path.
 * This record is immutable and serves to provide a standardized error response structure.
 *
