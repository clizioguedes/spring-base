...
/**
 * Utility class for converting one object (source) to another object (target) using reflection.
 * Provides a static method to parse and copy fields with matching names and types from source to target.
 */
public class Parser {
    ...
    /**
     * Parses the source object and creates a new instance of the target class, copying matching fields.
     *
     ...
     * @throws ConversionException if there is an error during the conversion process.
     */
